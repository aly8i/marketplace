  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.item}>
        {user.id?<Link href={`/user/${user.id}`} passHref>
          ...
          {user.username!="Guest"?<Image className={styles.avatar} src={user.img} alt="user" width="30px" height="30px" />:<AccountCircleIcon className={styles.avatar}/>}
          </motion.div>
        </Link>:
          <div className={styles.profilewrapper}>
          {user.username!="Guest"?<Image className={styles.avatar} src={user.img} alt="user" width="30px" height="30px" />:<Link href="/socialogin" passHref><AccountCircleIcon className={styles.avatar}/></Link>}
          </div>
        }
    ...
    whileTap={{ scale: 0.8}}>
            <div className={styles.cart}>
              <div className={styles.profilewrapper}><Image src="/img/cart.png" alt="" width="30px" height="30px" /></div>
